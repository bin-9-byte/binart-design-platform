      ...
      >
        ...
        <div className="h-full overflow-y-auto px-8 md:px-16 pt-32 pb-20 scrollbar-hide">
            ...
            <div className="mb-12">
                ...
                <p className="text-cream/50">Find stories, tools, and resources.</p>
            </div>
            ...
            <div className="relative group mb-16">
                ...
                <input 
                    ...
                    className="w-full bg-transparent border-b border-line/20 py-6 pl-12 pr-4 text-3xl font-display text-cream placeholder-cream/40 focus:outline-none focus:border-accent-orange transition-colors"
                />
            ...
            <div>
                ...
                <div className="flex flex-wrap gap-3">
                    {POPULAR_TAGS.filter(tag => tag.toLowerCase().includes(searchTerm.toLowerCase())).map((tag, idx) => (
                        <button 
                            key={idx}
                            className="px-4 py-2 rounded-full border border-line/10 bg-muted/5 text-sm text-cream/70 hover:bg-muted/10 hover:border-line/20 hover:text-cream hover:scale-105 active:scale-95 transition-all duration-300"
