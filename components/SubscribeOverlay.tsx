  ...
  return (
    ...
    >
      ...
      <div 
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="subscribe-overlay-title"
        aria-describedby="subscribe-overlay-description"
        tabIndex={-1}
      ...
      >
        ...
        <div className="h-full flex flex-col justify-center px-8 md:px-16 pb-20">
            {/* Header */}
            <div className="mb-12">
                <h2 id="subscribe-overlay-title" className="font-display font-bold text-5xl md:text-6xl text-cream mb-4">Subscribe</h2>
                <p id="subscribe-overlay-description" className="text-cream/60 text-lg max-w-md leading-relaxed">
            ...
            {status === 'success' ? (
              <div className="animate-fade-in-up bg-green-500/10 border border-green-500/20 p-8 rounded-lg flex flex-col items-center text-center">
                ...
                <button 
                  type="button"
                  onClick={onClose}
                  className="px-8 py-3 bg-muted/5 text-cream border border-line/10 font-bold uppercase tracking-widest hover:border-green-400 hover:text-green-400 transition-colors active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-400/60 focus-visible:ring-offset-4 focus-visible:ring-offset-surface rounded-sm"
                >
                  Continue Reading
                </button>
              </div>
              ...
              <form onSubmit={handleSubmit} className="relative group mb-16">
                  ...
                  <button 
                    ...
                    className="absolute right-0 top-1/2 -translate-y-1/2 flex items-center gap-2 text-sm font-bold uppercase tracking-widest text-cream/60 hover:text-accent-orange disabled:opacity-30 disabled:hover:text-cream/60 transition-colors active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-orange/50 focus-visible:ring-offset-4 focus-visible:ring-offset-surface rounded-sm px-2 py-2"
                  >
